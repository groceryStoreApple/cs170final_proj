...
def instance_solver(graph):
	...
	return solution_set,flag, "% = " + str(round(len(graph.nodes())/float(original_vertices_no), 2)) + "; #uncovered = " + str(len(graph.nodes())) + "; #vertex = " + str(original_vertices_no) + "; #edges = " + str(original_edges_no)
